...
@implementation UIImage (__CaptureImageEffectss)


- (UIImage *)__applyLightEffect
{
    UIColor *tintColor = [UIColor colorWithWhite:0.56 alpha:0.3];
...
- (UIImage *)__applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self __applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
